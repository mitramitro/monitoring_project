    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('nota-permintaan.export') }}" target="_blank">
                        <div class="row">
                            ...
                            <div class="col-lg-auto mb-3">
                                <button class="btn btn-warning reset-btn" id="reset_filter"
                                    title="Click here to remove filter" type="button">Reset Filter</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<script>
    ...
    var table = $('#tabel').DataTable({
        ...
        responsive: true,
        ajax: {
            url: "{{ route('nota-permintaan.index') }}",
            data: function(d) {
